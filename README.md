...
## 軽量版について
計測震度の算出方法にフィルターを掛けるようになってから処理が重くなり本来0.01秒ごとの処理が0.2秒ごとくらいになりました。  
フィルターを掛ける前と後の結果はあまり変わらないので、軽量版としてフィルターを一切かけず計測震度を計算する物も使用できます。  
[軽量版](https://anesewo.github.io/Shindokeisoku/keiryou)
